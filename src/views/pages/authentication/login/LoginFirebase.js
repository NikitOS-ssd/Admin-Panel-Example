...
import { Mail, Lock, Check } from "react-feather" //При подключении авторизации через стороние сервисы добавить "Facebook, Twitter, Github"
  ...
  render() {
    return (
      <React.Fragment>
        ...
        {/* Регистрация через стороние сервисы (на будущее) */}
